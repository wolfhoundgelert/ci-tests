...
::test::some::SomeTest_obj::__register();
::test::some::AnotherTest_obj::__register();
...
::EReg_obj::__register();
::test::some::AnotherOneTest_obj::__register();
::some::Some_obj::__register();
::some::Another_obj::__register();
...
::test::some::AnotherTest_obj::__boot();
::test::some::SomeTest_obj::__boot();
}
